...
""));
        ...
        pushButton_2->setStyleSheet(QString::fromUtf8("background-color: rgb(18,10,131);\n"
"font: 700 10pt \"Segoe UI\";\n"
...
""));
        ...
        pushbutton_addproduct = new QPushButton(frame_2);
        pushbutton_addproduct->setObjectName(QString::fromUtf8("pushbutton_addproduct"));
        pushbutton_addproduct->setMinimumSize(QSize(0, 35));
...
""));
        ...
        formLayout_2->setItem(6, QFormLayout::SpanningRole, horizontalSpacer_8);
...
""));
        ...
        formLayout_2->setWidget(7, QFormLayout::SpanningRole, pushButton_3);

        horizontalSpacer_6 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        formLayout_2->setItem(8, QFormLayout::SpanningRole, horizontalSpacer_6);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout_2->setItem(9, QFormLayout::LabelRole, verticalSpacer_3);
...
"border-radius: 5px;"));
        ...
        formLayout_2->setWidget(10, QFormLayout::SpanningRole, pushButton_4);

        horizontalSpacer_7 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        formLayout_2->setItem(11, QFormLayout::SpanningRole, horizontalSpacer_7);

        verticalSpacer_4 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout_2->setItem(12, QFormLayout::LabelRole, verticalSpacer_4);
    ...
    void retranslateUi(QMainWindow *Inventory)
    {
        ...
        pushbutton_addproduct->setText(QCoreApplication::translate("Inventory", "ADD PRODUCTS", nullptr));
